...
from egri.baseline import RLM_VANILLA_BASELINE_MODE
from egri.baseline import score_vanilla_truncation_baseline_completion
...
POLICY_SUBCALLS = {
    ...
    "egri": "selected_chunks + 1",
    "egri_substrate_without_tg": "selected_chunks + 1",
}
...
def _policy_completion(policy_id: str, fixture: dict[str, Any]) -> dict[str, Any]:
    ...
    if policy_id == "egri_substrate_without_tg":
        completion["result"]["rlm_trace"] = {
            "trace_valid": False,
