...
This module owns the new ``runtime-scaffold`` execution path. It intentionally does not
...
Do not invoke Ouroboros, do not run any runtime-scaffold command, and do not delegate recursively.
...
def _render_benchmark_report(
    ...
    *,
    ...
    lines = [
        ...
        f"- Invocation: `runtime-scaffold {config.target}`",
    ...
    *,
    ...
    envelope: dict[str, Any] = {
        ...
        "objective": {
            ...
            "non_goals": [
                "Do not invoke runtime-scaffold commands",
