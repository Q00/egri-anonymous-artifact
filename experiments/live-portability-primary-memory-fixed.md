# EGRI Live Portability Primary Run
...
Live primary mode executes the EGRI+TG contract for 24/24 planned primary cells. Aggregate status: `pass`. A pass supports the runtime portability claim; it does not evaluate secondary baselines or SOTA model quality.
