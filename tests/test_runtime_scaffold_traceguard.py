...
def test_runtime_scaffold_gate_accepts_parent_claims_with_fresh_child_handles() -> None:
    gate = validate_runtime_scaffold_result(
        _result(
            {
...
def test_runtime_scaffold_gate_rejects_unknown_child_result_handles() -> None:
    gate = validate_runtime_scaffold_result(
        _result(
            {
                "mode": "synthesize_parent",
...
def test_runtime_scaffold_gate_rejects_direct_memory_answer_fact() -> None:
    gate = validate_runtime_scaffold_result(
        _result(
            {
                "mode": "synthesize_parent",
