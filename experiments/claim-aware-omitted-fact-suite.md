...
| positive_omitted_fact_entry | yes | 0.6667 | 0.0 | `['LC-005']` | `[]` |
| unguarded_summary_claim | yes | 0.6667 | 0.0 | `['LC-005']` | `[]` |
| omitted_evidence_reference | yes | 0.6667 | 0.0 | `['LC-005']` | `[]` |
| chunk_ids_without_fact_evidence | yes | 0.6667 | 1.0 | `[]` | `['LC-001', 'LC-002', 'LC-003', 'LC-004']` |
| missing_truncation_boundary | yes | 0.6667 | 1.0 | `[]` | `[]` |
| missing_retained_fact | yes | 0.9167 | 1.0 | `[]` | `['LC-004']` |
